...
- Visual map pass: every one of the seven layers was loaded in Kathala; map images, gateways, and location markers were inspected at the fitted application scale.
